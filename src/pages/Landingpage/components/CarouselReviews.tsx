                ...
                >
                    <CarouselContent className="">
                        {Array.from({ length: 10 }).map((_, index) => (
                            <CarouselItem key={index} className="md:basis-1/2 lg:basis-1/3 h-1/2">
                                <div className="p-1">
                                    <Card className="">
                                        <CardContent className="grid relative aspect-video items-center justify-around px-8 w-full h-fit">
                                            <div className="flex space-x-8 w-full h-fit">
                                                <div className="h-full w-full flex flex-col justify-around items-start space-y-2  rounded-2xl">
                                                    ...
                                                    <p className="text-slate-600">This beauty services website is my go-to for all my beauty needs. The staff is friendly and professional.</p>
                                                    <div className="flex justify-center items-center space-x-4">
                                                        <img src="/img/DummyImage.png" className="size-12 object-cover aspect-square rounded-full"></img>
                                                        <div className="flex justify-center items-start flex-col">
                                                            <h6 className="font-bold text-lg">Lucy Rodriguez</h6>
                                                            <p>24 march</p>
                                                        </div>
                                                    </div>
                                                </div>
